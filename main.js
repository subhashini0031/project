...
angry_playlist = ["thee_angry"];
angry_title = ["thee_angry"];
angry_poster = ["static/song_imgs/thee.jpg"];

happy_playlist = ["sirikalam.happy"];
happy_title = ["sirikalam.happy"];
happy_poster = ["static/song_imgs/sirikalam parakalam.jpg"];

calm_playlist = ["evarum_calm"];
calm_title = ["evarum_calm"];
calm_poster = ["static/song_imgs/evarum sollamale.jpg"];

sad_playlist = ["kanaveneenaan_sad"];
sad_title = ["kanaveneenaan_sad"];
sad_poster = ["kanave ni nan.jpg"];
